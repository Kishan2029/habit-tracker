          ...
          <div className="grid grid-cols-2 gap-2">
            {category.templates.map((template) => (
              <button
                ...
                className="flex items-center gap-2 p-2.5 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-indigo-400 dark:hover:border-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-900/10 transition text-left"
              >
