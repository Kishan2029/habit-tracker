    ...
    <div className="relative overflow-hidden rounded-xl" {...handlers} ref={refCallback}>
      ...
      >
        <button
          ...
          className="flex-1 flex flex-col items-center justify-center gap-1 bg-gray-500 text-white text-xs font-medium focus:outline-none"
        >
        ...
        <button
          ...
          className="flex-1 flex flex-col items-center justify-center gap-1 bg-red-500 text-white text-xs font-medium focus:outline-none"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
